...
```{r}
#rodal<-subset(COPLAS_baza, RODAL == "GR000006")
rodal<-subset(COPLAS_baza, RODAL == "GR023008")
#rodal<-subset(COPLAS_baza, RODAL == "GR023012")
#rodal<-subset(COPLAS_baza, RODAL == "GR023015")
#rodal<-subset(COPLAS_baza, RODAL == "GR023017")
#rodal<-subset(COPLAS_baza, RODAL == "GR023021")

#rodal<-subset(COPLAS_snevada, RODAL == "GR000030")
#rodal<-subset(COPLAS_snevada, RODAL == "GR134018")
#rodal<-subset(COPLAS_snevada, RODAL == "GR134020")
#rodal<-subset(COPLAS_snevada, RODAL == "GR134021")
```
...
?Deberia ser una relacion inversa y no lo es
...
```{r}
plaga_ts<-ts(INSTAR[2:5], class=c("mts"), frequency=365)#Frecuencia es igual la numero de dias?
