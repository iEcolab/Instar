...
En las variables huevo, L1, L2 y crisalida: fecha del maximo. En la variable exergia fecha del maximo y el mínimo. 

*Nota: se puede calcular el minimo sin contar el 0?
*Duda: una vez hecha la regresion, como se calcula la tendencia?
```{r}
